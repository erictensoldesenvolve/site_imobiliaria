...
<div class="wrap wdk-wrap">
    ...
    <a class="image-link" target="_blank" href="https://swit.gumroad.com/l/wp-directory-multy-currency"><img class="presentation-image" src="<?php echo WPDIRECTORYKIT_URL; ?>admin/img/automatic-currency-conversion.jpg" /></a>

    <h2 class="wp-heading-inline"><?php echo __('Even on listing preview page', 'wpdirectorykit'); ?></h2>
    <a class="image-link" target="_blank" href="https://swit.gumroad.com/l/wp-directory-multy-currency"><img class="presentation-image" src="<?php echo WPDIRECTORYKIT_URL; ?>admin/img/automatic-currency-conversion-2.jpg" /></a>

    <h2 class="wp-heading-inline"><?php echo __('Admin can manage currencies', 'wpdirectorykit'); ?></h2>
    <a class="image-link" target="_blank" href="https://swit.gumroad.com/l/wp-directory-multy-currency"><img class="presentation-image" src="<?php echo WPDIRECTORYKIT_URL; ?>admin/img/currencies-management.jpg" /></a>
    ...
    <a class="image-link" target="_blank" href="https://swit.gumroad.com/l/wp-directory-multy-currency"><img class="presentation-image" src="<?php echo WPDIRECTORYKIT_URL; ?>admin/img/auto-sync-cron.jpg" /></a>
