 ...
 *
 * This is the template for booking presentation
 *
 */
...
<div class="wrap wdk-wrap">
    ...
    <a class="image-link" target="_blank" href="https://swit.gumroad.com/l/wp-directory-booking-calendar"><img class="presentation-image" src="<?php echo WPDIRECTORYKIT_URL; ?>admin/img/bookings-calendar.jpg" /></a>

    <h2 class="wp-heading-inline"><?php echo __('Frontend availability dates filtering', 'wpdirectorykit'); ?></h2>
    <a class="image-link" target="_blank" href="https://swit.gumroad.com/l/wp-directory-booking-calendar"><img class="presentation-image" src="<?php echo WPDIRECTORYKIT_URL; ?>admin/img/frontend-availability-search.jpg" /></a>

    <h2 class="wp-heading-inline"><?php echo __('Availability management', 'wpdirectorykit'); ?></h2>
    <a class="image-link" target="_blank" href="https://swit.gumroad.com/l/wp-directory-booking-calendar"><img class="presentation-image" src="<?php echo WPDIRECTORYKIT_URL; ?>admin/img/availability-management.jpg" /></a>

    <h2 class="wp-heading-inline"><?php echo __('My reservations management via Frontend Dashboard', 'wpdirectorykit'); ?></h2>
    <a class="image-link" target="_blank" href="https://swit.gumroad.com/l/wp-directory-booking-calendar"><img class="presentation-image" src="<?php echo WPDIRECTORYKIT_URL; ?>admin/img/frontend-dashboard.jpg" /></a>

    <h2 class="wp-heading-inline"><?php echo __('WooCommerce support for Online Booking payments', 'wpdirectorykit'); ?></h2>
    <a class="image-link" target="_blank" href="https://swit.gumroad.com/l/wp-directory-booking-calendar"><img class="presentation-image" src="<?php echo WPDIRECTORYKIT_URL; ?>admin/img/woocommerce_payment_support.jpg" /></a>

    <h2 class="wp-heading-inline"><?php echo __('Almost any world payment gateway supported', 'wpdirectorykit'); ?></h2>
    <a class="image-link" target="_blank" href="https://swit.gumroad.com/l/wp-directory-booking-calendar"><img class="presentation-image" src="<?php echo WPDIRECTORYKIT_URL; ?>admin/img/any-payment-gateway-support.jpg" /></a>
